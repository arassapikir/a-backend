...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield("title") | {{config()->get('project')->name}}</title>
        @yield('styles')

    </head>
    <body id="kt_body" class="page-loading-enabled page-loading header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-minimize aside-minimize-hoverable page-loading">

        <div class="page-loader page-loader-logo">
            <img alt="Logo" class="max-h-75px" src="{{asset("images/logo/logo.png")}}" />
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            ...
            <!--begin::Logo-->
            <a href="index.html">
                <img alt="Logo" src="{{asset("images/logo/logo-light.png")}}" />
            </a>
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('layouts.index')}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"/>
                                        ...
                                        <span class="menu-text">Layoutlar</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('fonts.index')}}" class="menu-link">
                                        ...
                                        <span class="menu-text">Fontlar</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('colors.index')}}" class="menu-link">
                                        ...
                                        <span class="menu-text">Color packs</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('icons.index')}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"/>
                                        ...
                                        <span class="menu-text">Icon packs</span>
                                    </a>
                                </li>

                                <li class="menu-section">
                                    <h4 class="menu-text">Harytlar</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('categories.index')}}" class="menu-link">
                                        ...
                                        <span class="menu-text">Kategoriýalar</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('products.index')}}" class="menu-link">
                                        ...
                                        <span class="menu-text">Harytlar</span>
                                    </a>
                                </li>


                                <li class="menu-section">
                                    <h4 class="menu-text">Sazlamalar</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{route('sliders.index')}}" class="menu-link">
                                        ...
                                        <span class="menu-text">Slaýderler</span>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                        <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">
                                            <i class="fas fa-bell icon-xl text-primary"></i>
                                    ...
                                    <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                        <form>
                                            ...
                                            <!--begin::Header-->
                                            <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{"images/defaults/bg-1.jpg"}})">
                            ...
                            <!--end::Svg Icon-->
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="topbar-item" data-offset="10px,0px">
                                        <a href="{{route("switch.lang", app()->getLocale() == "tk" ? "ru" : "tk")}}" class="btn btn-icon btn-clean btn-lg mr-1">
                                            <img class="h-20px w-20px rounded-sm" src="{{asset("images/flags/" . (app()->getLocale() == "tk" ? "ru" : "tk") . ".svg")}}" alt="" />
                                        </a>
                                    </div>
                                    <!--end::Toggle-->
                                </div>
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                        ...
                                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Sapar aga</span>
                    ...
                    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="http://arassapikir.com.tm" target="_blank" class="text-dark-75 text-hover-primary">Arassa Pikir - Ähli hukulary goralan</a>
                            </div>
                            ...
                            <div class="nav nav-dark">
                                <a href="http://arrassapikir.com.tm" target="_blank" class="nav-link pl-0 pr-5">Gizlinlik</a>
                                <a href="http://arrassapikir.com.tm" target="_blank" class="nav-link pl-0 pr-5">Ulanyş düzgünleri</a>
                                <a href="http://arrassapikir.com.tm" target="_blank" class="nav-link pl-0 pr-0">Habarlaşmak üçin</a>
                            </div>
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                <h3 class="font-weight-bold m-0">Hasabym
                </h3>
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label" style="background-image:url({{asset('images/defaults/user.jpg')}})"></div>
                        <i class="symbol-badge bg-success"></i>
                    </div>
                    <div class="d-flex flex-column">
                        <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">Sapar aga</a>
                        ...
                        <div class="navi mt-2">
                            <a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">64 871221</span>
								</span>
                            </a>
                            <a href="#" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Hasapdan çyk</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="navi navi-spacer-x-0 p-0">
                    ...
                    <a href="#" class="navi-item">
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                <div class="font-weight-bold">Profilimi üýtget</div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#" class="navi-item">
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                <div class="font-weight-bold">Parol çalyş</div>
                            </div>
                        </div>
                    </a>
